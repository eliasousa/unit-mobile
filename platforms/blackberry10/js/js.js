  ...
  var remoteFile = "https://wwws.unit.br/DiscoVirtualNet/Arquivos/DownloadMobileIphone.ashx?idt_arquivo=" + idtArquivo + "&username=" + matricula + "&session_id=" + sessionID;
    ...
    try {   
       blackberry.io.filetransfer.download(
        remoteFile,
        blackberry.io.sharedFolder + "/downloads/" + nomeArquivo,
        function (result) {
            loader(0);
...
function open(file) {
    try {
        blackberry.invoke.invoke({
            ...
            uri: "file://" + blackberry.io.sharedFolder + "/downloads/" + file
